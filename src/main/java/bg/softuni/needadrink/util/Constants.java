...
public class Constants {
    ...
    public final static String DEFAULT_INGREDIENT_IMG_URL = "/images/default_cocktail_img.svg";

    public static final String INVALID_JSON_DATA_ERROR = "Invalid Json input Data!";
